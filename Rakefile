...
runtime_deps = {
  ...
  :rainbow => '1.0.1', 'mojombo-grit' => '1.1.1', :dnssd => '0.6.0', :rack => "0.9.1",
  :thin => "1.0.0", "haml-edge" => '2.1.7'
}
...
gem = Gem::Specification.new do |gem|
  ...
  gem.summary          = "Local git repository hosting with a sexy web interface and bonjour discovery. It's like a adhoc, local, network-aware github!"
